...
public class AccesoPedido {
      public void insertarPedido(Pedido pedido){
        ...
        PreparedStatement enviarUpdate=null;
	//
        try {
            ...
            enviarUpdate=conexion.prepareStatement(queryUpdate);
            ...
            conexionMySQL.Conexion.close(enviarDividido);
            conexionMySQL.Conexion.close(enviarUpdate);
