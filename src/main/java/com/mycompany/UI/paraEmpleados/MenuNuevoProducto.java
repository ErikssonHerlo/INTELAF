...
public class MenuNuevoProducto extends javax.swing.JFrame {
     ...
     */
    public MenuNuevoProducto(String nombreTienda, String codigoTienda) {
    ...
    private void initComponents() {
        ...
        agregarExistencias = new javax.swing.JButton();
        ...
        getContentPane().add(crearNuevoProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 180, 290, 40));
        ...
        agregarExistencias.setBackground(new java.awt.Color(43, 46, 46));
        agregarExistencias.setFont(new java.awt.Font("DejaVu Serif Condensed", 1, 15)); // NOI18N
        agregarExistencias.setForeground(new java.awt.Color(250, 250, 244));
        agregarExistencias.setText("Agregar Existencias a Producto");
        agregarExistencias.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agregarExistenciasActionPerformed(evt);
            }
        });
        getContentPane().add(agregarExistencias, new org.netbeans.lib.awtextra.AbsoluteConstraints(175, 240, 290, 40));
    ...
    private void crearNuevoProductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_crearNuevoProductoActionPerformed
        NuevoProducto eleccion = new NuevoProducto(nombreTienda, codigoTienda);
        eleccion.setVisible(true);
              this.setVisible(false);        // TODO add your handling code here:
    }//GEN-LAST:event_crearNuevoProductoActionPerformed

    private void agregarExistenciasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarExistenciasActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_agregarExistenciasActionPerformed
    ...
    public javax.swing.JButton agregarExistencias;
