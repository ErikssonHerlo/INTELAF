...
public class NuevoCliente extends javax.swing.JFrame {
     ...
     */
    public NuevoCliente(String nombreTienda, String codigoTienda) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 90, 420, 53));
        ...
        inUsuario2.setText("Ingrese el NIT:                 *");
        ...
        inUsuario4.setText("Ingrese el Credito:            ");
        ...
        inUsuario5.setText("Ingrese el DPI:                 ");
    ...
    private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
        ...
        String NIT=textoUsuario2.getText();
        String telefono=textoUsuario3.getText();
        Double creditoCompra = 0.0;
        if (!textoUsuario4.getText().equals(""))
        {   creditoCompra = Double.parseDouble(textoUsuario4.getText());
        }
        String DPI = textoUsuario5.getText();
