...
public class Reporte6 extends javax.swing.JFrame {
     ...
     */
    public Reporte6(String nombreTienda, String codigoTienda) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(buscarTienda, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 270, 150, 30));
        ...
        descripcionReporte.setText("Pedidos en curso de un Cliente");
        getContentPane().add(descripcionReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 75, 300, 30));
        ...
        getContentPane().add(comboNITCliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 190, 150, 30));
        ...
        getContentPane().add(inUsuario12, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 130, 130, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 130, 780, 170));

        Fondo.setBackground(new java.awt.Color(59, 55, 51));
        Fondo.setText("Fondo General");
        getContentPane().add(Fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 970, 380));
    ...
    private void mostrarTablaCompleta(String NITCliente) {
        ...
        ResultSet rs = Conexion.getTabla("SELECT * FROM PEDIDO WHERE NIT_Cliente='"+NITCliente+"'");
    ...
    private void exportarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportarReporteActionPerformed
        if(comboNITCliente.getSelectedIndex()!=0){    
            Reporte6HTML reporte = new Reporte6HTML();
            reporte.generarReporte(tablePedidos, listaNombreCliente.get(comboNITCliente.getSelectedIndex()-1));
