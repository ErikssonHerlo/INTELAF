...
public class Reporte9 extends javax.swing.JFrame {
     ...
     */
    public Reporte9(String nombreTienda, String codigoTienda) {
    ...
    private void initComponents() {
        ...
        tablePedidos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Fabricante", "Codigo Producto", "Existencia", "Precio", "Codigo Tienda", "Descripcion", "Garantia"
            }
        ) {
        ...
        descripcionReporte.setText("Productos que no se han vendido en la Tienda");
        getContentPane().add(descripcionReporte, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 70, 430, 30));
    ...
    private void mostrarTablaCompleta() {
        ...
        ResultSet rs = Conexion.getTabla("SELECT e.* FROM EXISTENCIA_PRODUCTO e WHERE Codigo_Producto NOT IN(SELECT d.Codigo_Producto FROM DETALLE_VENTAS d WHERE d.Tienda_Existencia = '"+codigoTienda+"' GROUP BY Codigo_Producto) AND e.Codigo_Tienda ='"+codigoTienda+"'");
        
        model.setColumnIdentifiers(new Object[]{"Nombre", "Fabricante", "Codigo Producto", "Existencia","Precio","Codigo Tienda","Descripcion","Garantia"});
    ...
    private void exportarReporteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_exportarReporteActionPerformed
        Reporte9HTML reporte = new Reporte9HTML();
