...
public class VisualizarTienda extends javax.swing.JFrame {
     ...
     */
    public VisualizarTienda(String nombreTienda, String codigoTienda) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, 230, 53));
        ...
        tableTiendas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Direccion", "Codigo Tienda", "Telefono 1", "Telefono 2", "Horario", "E-Mail"
            }
        ) {
        ...
        verTodos.setText("Ver Todas las Tiendas");
    ...
    private void mostrarTablaCompleta() {
        ...
        ResultSet rs = conexion.getTabla("SELECT * FROM TIENDA");
         model.setColumnIdentifiers(new Object[]{"Nombre", "Direccion", "Codigo Tienda", "Telefono 1","Telefono 2","Horario","E-Mail"});
        
        try {
            while (rs.next()) {
               
                model.addRow(new Object[]{rs.getString("Nombre"), rs.getString("Direccion"), rs.getString("Codigo_Tienda"), rs.getString("Telefono_1"),rs.getString("Telefono_2"),rs.getString("Horario"),rs.getString("Correo_Electronico")});
            }
            tableTiendas.setModel(model);
 ...
 private void mostrarTablaBusqueda(String tienda) {
        DefaultTableModel model = new DefaultTableModel();
        Conexion conexion = new Conexion();
        ResultSet rs = conexion.getTabla("SELECT * FROM TIENDA WHERE Codigo_Tienda= '"+tienda+"'");
        model.setColumnIdentifiers(new Object[]{"Nombre", "Direccion", "Codigo Tienda", "Telefono 1","Telefono 2","Horario","E-Mail"});
    ...
    private void buscarTiendaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarTiendaActionPerformed
        if(comboTienda.getSelectedIndex()!=0){
            mostrarTablaBusqueda(tablaProductosTiendaOrigen.get(comboTienda.getSelectedIndex()-1));
