 ...
 */
public class ModeloCatalogo extends javax.swing.JFrame {
     ...
     */
    public ModeloCatalogo(String nombreTienda, String codigoTienda) {
    ...
    private void initComponents() {
        ...
        tableRegistroPaquetes = new javax.swing.JTable();
        ...
        tableRegistroPaquetes.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tableRegistroPaquetes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tableRegistroPaquetesMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(tableRegistroPaquetes);
        ...
        getContentPane().add(comboNombreProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 110, 150, 30));

        comboCodigoProducto.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Codigo Producto" }));
        ...
        getContentPane().add(comboCodigoProducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 150, 150, 30));
        ...
        getContentPane().add(comboTienda, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 190, 150, 30));
        ...
        getContentPane().add(buscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 225, 150, 30));
    ...
    private void llenarCombos() {
        ...
        try {
            while (rs1.next()) {
                ...
                comboCodigoProducto.addItem(rs1.getString(3));
...
if(!Character.isDigit(evt.getKeyChar())&&evt.getKeyChar()!='.'){
    ...
    private void tableRegistroPaquetesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableRegistroPaquetesMouseClicked

    }//GEN-LAST:event_tableRegistroPaquetesMouseClicked
    ...
    private javax.swing.JTable tableRegistroPaquetes;
