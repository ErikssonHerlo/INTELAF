 ...
 */
public class Reporte4HTML {
    
    public void generarReporte(JTable tabla, String tiendaOrigen) {
        
        try {
            
            try (FileWriter archivo = new FileWriter("4-Reporte Pedidos que salieron de la Tienda "+tiendaOrigen+".html")) {
                ...
                *Se realiza la escritura del archivo con la estructura HTML
                ...
                out.write("        <header>\n");
                out.write("            <h1> Pedidos salieron de la Tienda </h1>\n");
                out.println("<h2>" + tiendaOrigen + "</h2>");
                out.write("        </header>\n");
                out.write("        <br>\n");
