 ...
 */
public class Reporte6HTML {
    
    public void generarReporte(JTable tabla, String NITCliente) {
        
        try {
            
            try (FileWriter archivo = new FileWriter("6-Reporte de Pedidos del Cliente "+NITCliente+".html")) {
                ...
                *Se realiza la escritura del archivo con la estructura HTML
                ...
                out.write("        <header>\n");
                out.write("            <h1> Pedidos del Cliente </h1>\n");
                out.println("<h2>" + NITCliente + "</h2>");
                out.write("        </header>\n");
                out.write("        <br>\n");
